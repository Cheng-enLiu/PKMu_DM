    ...
    TString dm4ROOTfilename="smeared_rec_poca_DM_1GeV_0722.root")
{
    ...
    for(i=0;i<nentries_exp;i++){
        ...
        if (times[1]<0 || times[10]<0 || times[11]<0 || times[12]<0 || times[13]<0 || times[14]<0 || times[15]<0 || times[16]<0 || times[17]<0 || times[18]<0 || times[19]<0 ||
            ...
            continue;
        if(z>200||z<-200) continue;
        if(x>145||x<-145) continue;
        if(y>145||y<-145) continue;
    ...
    for(i=0;i<nentries_sim;i++){
        ...
        if(xs>145||xs<-145) continue;
        if(ys>145||ys<-145) continue;
    ...
    for(i=0;i<nentries_dm4;i++){
        ...
        if(dm4z>200||dm4z<-200) continue;
        if(dm4x>145||dm4x<-145) continue;
        if(dm4y>145||dm4y<-145) continue;
    ...
    h_obs->Scale(((1.0)/h_obs->Integral()));
    h_mu->Scale(((1.0)/h_mu->Integral())*0.352605);
    h_e->Scale(((1.0)/h_e->Integral())*0.514695);
    h_other->Scale(((1.0)/h_other->Integral())*0.1327);
    ...
    //h_const_1->Scale(((1.0)*(exp_count))/(dm4_count)*0.352605);
    h_const_1->Scale((1.0)/(h_const_1->Integral()));

    h_mu1->Scale(((1.0)/h_mu1->Integral())*((0.352605)+(0.02877)));
    h_e1->Scale(((1.0)/h_e1->Integral())*((0.514695)+(0.11020)));
    h_other1->Scale(((1.0)/h_other1->Integral())*((0.1327)+(0.0014)));
    h_air1->Add(h_mu1);
    h_air1->Add(h_e1);
    h_air1->Add(h_other1);

    h_mu2->Scale(((1.0)/h_mu2->Integral())*((0.352605)-(0.02877)));
    h_e2->Scale(((1.0)/h_e2->Integral())*((0.514695)-(0.11020)));
    h_other2->Scale(((1.0)/h_other2->Integral())*((0.1327)-(0.0014)));
    h_air2->Add(h_mu2);
    h_air2->Add(h_e2);
    h_air2->Add(h_other2);
    
    h_mu3->Scale(((1.0)/h_mu3->Integral())*((0.352605)+2*(0.02877)));
    h_e3->Scale(((1.0)/h_e3->Integral())*((0.514695)+2*(0.12523)));
    h_other3->Scale(((1.0)/h_other3->Integral())*((0.1327)+2*(0.0014)));
    h_air3->Add(h_mu3);
    h_air3->Add(h_e3);
    h_air3->Add(h_other3);

    h_mu4->Scale(((1.0)/h_mu4->Integral())*((0.352605)-2*(0.02877)));
    h_e4->Scale(((1.0)/h_e4->Integral())*((0.514695)-2*(0.11020)));
    h_other4->Scale(((1.0)/h_other4->Integral())*((0.1327)-2*(0.0014)));
    h_air4->Add(h_mu4);
    h_air4->Add(h_e4);
    h_air4->Add(h_other4);
    ...
    h_mu_copy->Scale(((1.0)/h_mu_copy->Integral())*0.352605);
    h_e_copy->Scale(((1.0)/h_e_copy->Integral())*0.514695);
    h_other_copy->Scale(((1.0)/h_other_copy->Integral())*0.1327);
    ...
    h_mu1_copy->Scale(((1.0)/h_mu1_copy->Integral())*((0.352605)+(0.02877)));
    h_e1_copy->Scale(((1.0)/h_e1_copy->Integral())*((0.514695)+(0.11020)));
    h_other1_copy->Scale(((1.0)/h_other1_copy->Integral())*((0.1327)+(0.0014)));
    h_air1_copy->Add(h_mu1_copy);
    h_air1_copy->Add(h_e1_copy);
    h_air1_copy->Add(h_other1_copy);

    h_mu2_copy->Scale(((1.0)/h_mu2_copy->Integral())*((0.352605)-(0.02877)));
    h_e2_copy->Scale(((1.0)/h_e2_copy->Integral())*((0.514695)-(0.11020)));
    h_other2_copy->Scale(((1.0)/h_other2_copy->Integral())*((0.1327)-(0.0014)));
    ...
    legend->AddEntry(h_mu, Form("MC_#mu (%.1f%% #pm 2.9%%)", (h_mu->Integral() * 1.0)/(h_air->Integral() * 1.0)*100.0 ), "l");
    legend->AddEntry(h_e, Form("MC_e (%.1f%% #pm 11.0%%)", (h_e->Integral() * 1.0)/(h_air->Integral() * 1.0)*100.0), "l");
